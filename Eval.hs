...
-- This is only used in the typechecker
...
hcomp i a u us = case a of
  ...
  VU -> hcompUniv u (mapSystem (VPLam i) us)
...
comp i a u us = case a of
    ...
    VPi{} -> VComp (VPLam i a) u (mapSystem (VPLam i) us)
...
-- TODO: remove by making VComp take a name
